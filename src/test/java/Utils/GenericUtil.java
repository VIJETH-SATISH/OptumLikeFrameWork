...
public class GenericUtil {
	 ...
	 * like how if it was set to false initially can vbe set again though final antha)
	 * and can set this value to truein step -->staleCounter.set(true);
	 * Once set to true it cannot be set to anything else as its final
	 * and since each and every thread gets its own ThreadLocal I can ue */
